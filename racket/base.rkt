...
(struct tetris (campo largura altura tetra proximos timeout pontuacao nivel) #:transparent)
...
;;                       automovimento
;;   pontuacao : Natural - é a pontuação do jogo
;;   nivel : Natural - é o nivel do jogo
;;
...
;; cor do fundo do jogo
(define COR-FUNDO "Light Steel Blue")

;; Divisor utilizado para setar a dificuldade do jogo
;; No caso da escolha do numeral 3 quer dizer que a cada 3 linhas retiradas 
;; o jogo ficara mais dificil
(define DIVISOR 3)
...
(define CORES (list "Light Steel Blue"
                    "cyan"
                    "blue"
                    "orange"
                    "yellow"
...
(define (make-tetris largura altura tetras timeout pontuacao nivel)
